...
// displaying data
    displayweather: function(data){
        ...
        var speed2 = data.list[8].wind.speed;
        var speed3 = data.list[16].wind.speed;
        var speed4 = data.list[24].wind.speed;
        var speed5 = data.list[32].wind.speed;

        console.log(name,temp1,humidity1,icon1,speed1,description1);

        document.querySelector(".city").innerText = "Weather in " + name + " for the next 5 days";
